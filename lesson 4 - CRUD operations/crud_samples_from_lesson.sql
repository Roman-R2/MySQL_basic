...
-- INSERT INTO `Users` (`id`, `first_name`, `last_name`, `email`, `password_hash`, `phone_number`) VALUES ('58', 'Dean', 'Satterfield', 'orin69@example.net', '16c1440628fdde98ced99bf5569e0073ce1d475f', '9160120629');

INSERT INTO `Users` ( `first_name`, `last_name`, `email`, `password_hash`, `phone_number`) VALUES ('Marilou', 'Ernser', 'georgtte10@example.org', 'fda0c6d489a126590cecd253366fba0f73f3830', 456465445366);

INSERT INTO users VALUES
('5', 'Reuben', 'Nienow', 'arlo515@example.org', NULL, 1),
('6', 'Reuben', 'Nienow', 'arlo516@example.org', NULL, 2),
('7', 'Reuben', 'Nienow', 'arlo517@example.org', NULL, 3),
('8', 'Reuben', 'Nienow', 'arlo518@example.org', NULL, 4)
;

...
По практическому заданию по теме «Операторы, фильтрация, сортировка и ограничение» решения в файле **lesson_5_operators_filtering_sorting.sql**

По практическом у заданию по теме «Агрегация данных» решения в файле **lesson_5_data_aggregation.sql**